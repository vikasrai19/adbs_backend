...
(
  `BoardingPointid` varchar
(60) NOT NULL,
  `BoardingPointName` varchar
(70) NOT NULL,
  `BoardingPointNO` int
(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(
  `busBoardingPointId` varchar
(40) NOT NULL,
  `collegeBusId` varchar
(40) NOT NULL,
  `academicyearId` varchar
(40) NOT NULL,
  `boardingPointId` varchar
(40) NOT NULL,
...
INSERT INTO `busboardingpoints` (`
busBoardingPointId`,
`collegeBusId
`, `academicyearId`, `boardingPointId`, `boardingTime`, `dropTime`) VALUES
...
INSERT INTO `collegebus` (`
collegeBusId`,
`busNo
`, `routeNo`, `regDate`, `purchaseDate`, `startingPoint`, `endingPoint`, `noOfSeats`, `busImage`) VALUES
...
INSERT INTO `collegebusemployee` (`
collegeBusEmpId`,
`name
`, `collegeBusId`, `designationId`, `startDate`, `endDate`, `phono`, `empimg`, `currentStatus`) VALUES
...
usn`,
`name
`, `email`, `mobileno`, `busNo`, `stdImage`, `password`) VALUES
...
(40) NOT NULL,
  `email` varchar
(60) NOT NULL COMMENT 'ex@gmail.com',
  `password` varchar
(40) NOT NULL,
  `userImage` varchar
(1000) NOT NULL,
...
userId`,
`name
`, `mobileno`, `busNo`, `email`, `password`, `userImage`, `usertype_id`) VALUES
...
ADD PRIMARY KEY
(`busBoardingPointId`),
ADD KEY `collegeBusId_FK`
(`collegeBusId`),
ADD KEY `academicyearId_FK`
(`academicyearId`),
ADD KEY `boardingPointId_FK`
(`boardingPointId`);
...
--
ALTER TABLE `collegebusemployee`
ADD CONSTRAINT `collegebusemployee_ibfk_1` FOREIGN KEY
(`collegeBusId`) REFERENCES `collegebus`
(`collegeBusId`),
ADD CONSTRAINT `collegebusemployee_ibfk_2` FOREIGN KEY
(`designationId`) REFERENCES `designation`
(`designation_id`);
...
--
ALTER TABLE `collegebususers`
ADD CONSTRAINT `collegebususers_ibfk_1` FOREIGN KEY
(`user`) REFERENCES `users`
(`userId`),
ADD CONSTRAINT `collegebususers_ibfk_2` FOREIGN KEY
(`busBoardingPointId`) REFERENCES `busboardingpoints`
(`busBoardingPointId`),
ADD CONSTRAINT `collegebususers_ibfk_3` FOREIGN KEY
(`academicyearId`) REFERENCES `academicyear`
(`academicyear_id`);
...
(`usertype_id`) REFERENCES `usertype`
(`usertype_id`);
COMMIT;
